...
TEST(RuntimeContextTest, WhatIsGoingOn){

  context::RuntimeContext::Token token = context::RuntimeContext::Attach(context::RuntimeContext::GetCurrent().SetValue("span_key",(int64_t)5));
  context::Context temp_context = context::RuntimeContext::GetCurrent(); 
  std::cout << "get int:"<< nostd::get<int64_t>(temp_context.GetValue("span_key")) << std::endl;
}
/*
